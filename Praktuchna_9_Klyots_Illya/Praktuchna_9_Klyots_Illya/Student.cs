...
namespace Praktuchna_9_Klyots_Illya
{
    ...
    public class Student : UniversityMember, IComparable<Student>, ICloneable
    {
        ...
        {
            if (newGrade < 0 || newGrade > 10) throw new ArgumentException("Бал від 0 до 10.");
            this.AverageGrade = newGrade;
            AverageGradeChanged?.Invoke(this, new StudentEventArgs(this));
        }
